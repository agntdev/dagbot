...
const HELP =
  "Я помогаю общаться на выбранном языке и помню короткий контекст разговора.\n\n" +
  "Нажми /start, чтобы открыть кнопки: новый чат, вопрос, язык, настройки и информация о боте.";
